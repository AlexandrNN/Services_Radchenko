...
Процедура ПриГлобальномПоиске(СтрокаПоиска, ПланПоиска)
	...
	Если СтрНачинаетсяС(СтрокаПоиска, "№") = 1 Тогда
...
Процедура ПриНачалеРаботыСистемы()
	...
	//Удалить из плана поиска поиск "Функции для тех спец" и поиск по справке
	...
	ГлобальныйПоиск.УстановитьОписание("Введите строку поиска, ссылку или арифметическое выражение." +
	                               Символы.ПС + 
	                                   "Для поиска документов об оказании услуг по номеру введите ""№"" 
	                                   |и сразу за ним без пробела часть номера.");
