...
Процедура РассчитатьНачисления(НаборЗаписейРегистра, ТребуемыйВидРасчета,
	 ...
	 //Рассчитать первичные записи (ОКЛАД)
	 	...
	 	Для Каждого ЗаписьРегистра Из НаборЗаписейРегистра Цикл
	 		...
	 		Если ВыборкаРезультата.НайтиСледующий(СтруктураНомер) Тогда
	 			...
	 			Иначе
	 				...
	 				Сообщение = Новый СообщениеПользователю();
	 				Сообщение.Текст = "Выполнен расчет " + ЗаписьРегистра.Регистратор + "-" + ЗаписьРегистра.Сотрудник;
	 				Сообщение.Сообщить();
	 ...
	 //Рассчитать вторичные записи (ПРЕМИЯ)
	 ИначеЕсли ТребуемыйВидРасчета = ПланыВидовРасчета.ОсновныеНачисления.Премия Тогда 
	 	...
	 	|ИЗ
	 	|	РегистрРасчета.Начисления.БазаНачисления(&ИзмеренияОсновного, &ИзмеренияБазового,, Регистратор = &Регистратор
...
Процедура ПерерассчитатьНачисления(ТребуемыйВидРасчета) Экспорт
	...
	//Перебрать группировку по сотруднкам для выбранного регистратора
	...
	//Получить набор записей регистра расчета ддля выбранного регистратора
